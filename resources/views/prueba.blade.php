        ...
        <div class="container header-container">
            ...
            <div class="nav-menu" id="navMenu">
                <ul class="nav-list">
                    ...
                    <li class="nav-item"><a href="politicas.html" class="nav-link">Políticas</a></li>
                </ul>
            ...
            <div class="hero-slide active">
                ...
                <div class="container hero-content">
                    <div class="hero-text">
                        ...
                        <p class="hero-subtitle">Desarrollamos sistemas y aplicaciones web con la más alta tecnología para impulsar la eficiencia de su empresa.</p>
            ...
            <div class="hero-slide">
                ...
                <div class="container hero-content">
                    <div class="hero-text">
                        ...
                        <p class="hero-subtitle">Creamos sistemas personalizados que se adaptan perfectamente a las necesidades específicas de su negocio.</p>
                        <div class="hero-btn-group">
            ...
            <div class="hero-slide">
                ...
                <div class="container hero-content">
                    <div class="hero-text">
                        ...
                        <p class="hero-subtitle">Contribuimos al desarrollo tecnológico con soluciones innovadoras que potencian el crecimiento empresarial.</p>
                        <div class="hero-btn-group">
            ...
            <div class="platforms-grid">
                ...
                <div class="platform-card fade-in-up delay-300">
                    ...
                    <div class="platform-content">
                        ...
                        <a href="https://portal-nom035.grupocots.com" target="_blank" class="platform-btn">Acceder <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                ...
                <div class="platform-card fade-in-up delay-500">
                    ...
                    <div class="platform-content">
                        ...
                        <a href="https://clinico.grupocots.com" target="_blank" class="platform-btn">Acceder <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
